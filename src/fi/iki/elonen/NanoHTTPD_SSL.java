 ...
 */
public abstract class NanoHTTPD_SSL {
    /**
     ...
     */
    public NanoHTTPD_SSL(String hostname, int port) {
   ...
   public static SSLServerSocketFactory makeSSLSocketFactory(String keyAndTrustStoreClasspathPath, char[] passphrase) throws IOException {
      ...
      try {
         ...
         InputStream keystoreStream = NanoHTTPD_SSL.class.getResourceAsStream(keyAndTrustStoreClasspathPath);
