...
public class WeatherConditions 
{
	...
	public WeatherConditions(String xml, /*Locale locale,*/ String tempUnit)
	{
		...
		*/
		...
		matcher = PATTERN_DESC_IMAGE.matcher(xml);
		if (matcher.find())
		{
			this.descImage = matcher.group(1);
		}
	...
	*/
	...
	protected Pattern PATTERN_DESC_IMAGE  = Pattern.compile("<description>.*<img src=\"([^\"]*)\"",   Pattern.MULTILINE|Pattern.DOTALL);
